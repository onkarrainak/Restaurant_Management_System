...
//				System.out.println(newquantity + " " + foodItem + " added in order."); 
				if (customer.update(foodItem, newquantity)) {
	...
	public static void main(String[] args) {
		...
		while (wantToContinue) {
			...
			case 2:
				...
				break;
			case 3:
				System.out.println("Thank you for being our guest. We hope you enjoy your dining experience.");
